...
It looks like you got the bootstrap to work and successfully recieved CIs from it. I also tried making a function for it first using some code I found online, but I wasn't sure what all of the components meant. Similarly with yours, I'm not sure what the "idx" in the bsReg function or the "indices" in the bs function are supposed to mean. But, it still works, I think it could just use a bit more annotating. Also, I'm getting an error in the bsReg coefficient line.
